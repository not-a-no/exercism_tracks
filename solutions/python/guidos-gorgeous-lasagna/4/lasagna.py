...
def preparation_time_in_minutes(number_of_layers):
    ...
    Function that takes the number of layers in the lasagna as an argument and returns how many minutes the lasagna need to be prepared based on the `number_of_layers`.
    """
